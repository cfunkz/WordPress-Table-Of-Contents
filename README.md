...
Smart TOC is the middleground: a single PHP file with a full admin panel integration, shortcode support, per-post overrides, and deep design customisation.
